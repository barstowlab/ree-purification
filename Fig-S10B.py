...
for purity in targetPurities:
	...
	microbe1_fB1_Array_local = microbe1_fB1_Array[firstIndex:-1]
	microbe1_fB2_Array_local = microbe1_fB2_Array[firstIndex:-1]
	microbe1_fB3_Array_local = microbe1_fB3_Array[firstIndex:-1]

	microbe2_fB1_Array_local = microbe2_fB1_Array[firstIndex:-1]
	microbe2_fB2_Array_local = microbe2_fB2_Array[firstIndex:-1]
	microbe2_fB3_Array_local = microbe2_fB3_Array[firstIndex:-1]

	microbe3_fB1_Array_local = microbe3_fB1_Array[firstIndex:-1]
	microbe3_fB2_Array_local = microbe3_fB2_Array[firstIndex:-1]
	microbe3_fB3_Array_local = microbe3_fB3_Array[firstIndex:-1]
	
	microbe1_fB1_increase_array_local = microbe1_fB1_increase_array[firstIndex:-1]
	microbe2_fB2_increase_array_local = microbe2_fB2_increase_array[firstIndex:-1]
	microbe3_fB3_increase_array_local = microbe3_fB3_increase_array[firstIndex:-1]
...
headers = ['microbe1_fB1']
vectorList = [microbe1_fB1_Array]
